...
//             {/* <!--End Col--> */}
//             <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
//               <h4 className="text-lg text-center text-white font-medium mb-7 lg:text-left">
//                 Newsletter
//               </h4>
...
//                 <button
//                   type="submit"
//                   className="h-11 py-3 px-6 bg-secondary transition-all duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:bg-primary"
//                 >
//                   Subscribe
//                 </button>
//               </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 gap-8 py-10 lg:py-14 lg:grid-cols-8">
          ...
          <div className="col-span-full sm:col-span-4 lg:col-span-2 text-center lg:text-left">
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              />
              <button className="h-12 px-6 bg-secondary text-white rounded-full hover:bg-primary transition-all">
                Subscribe
              </button>
            </div>
          </div>
